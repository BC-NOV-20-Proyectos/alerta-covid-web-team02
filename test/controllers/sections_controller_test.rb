...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference('Section.count') do
      post sections_url, params: { section: { institute_id: @section.institute_id, name: @section.name } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { institute_id: @section.institute_id, name: @section.name } }
